...
s2.metric("Best Accuracy",   "95.83%", help="KNN model on test set")
s3.metric("Best Recall",     "97.44%", help="KNN correctly found 97.44% of depressed students")
...
with c2:
    with st.container(border=True):
        ...
        st.write("K-Nearest Neighbor · **95.83%** accuracy · K = 5 · Depression")
...
with c3:
    with st.container(border=True):
        ...
        st.write("CART Algorithm · **85.50%** accuracy · Depth 5 · Depression")
...
with c6:
    with st.container(border=True):
        ...
        st.write("600 records · 11 features · Preprocessing steps and summary.")
